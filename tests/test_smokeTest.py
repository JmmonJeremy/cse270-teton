...
class TestSmokeTest():
  ...
  def test_4JoinPageTest(self):
    ...
    assert len(elements) > 0
    self.vars["Jeremy"] = self.driver.execute_script("document.getElementsByName(\'fname\')[0].value=\'Jeremy\'")
    self.driver.find_element(By.NAME, "lname").click()
    self.vars["Suchanski"] = self.driver.execute_script("document.getElementsByName(\'lname\')[0].value=\'Suchanski\'")
    self.driver.find_element(By.NAME, "bizname").click()
    self.vars["Diaper Mania"] = self.driver.execute_script("document.getElementsByName(\'bizname\')[0].value=\'Diaper Mania\'")
    self.driver.find_element(By.NAME, "biztitle").click()
    self.vars["Diaper Man"] = self.driver.execute_script("document.getElementsByName(\'biztitle\')[0].value=\'Diaper Man\'")
